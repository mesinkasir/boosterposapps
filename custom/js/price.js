...
$(document).ready(function() {
	...
	manageProductTable = $('#manageProductTable').DataTable({
		'ajax': 'php_action/fecthPrice.php',
		'order': []
	});
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(productName == "") {
				$("#productName").after('<p class="text-danger">Masukan nama produk</p>');
			...
			if(quantity == "") {
				$("#quantity").after('<p class="text-danger">Qty Stok harus dimasukan</p>');
			...
			if(rate == "") {
				$("#rate").after('<p class="text-danger">Masukan harga jual</p>');
			...
			if(brandName == "") {
				$("#brandName").after('<p class="text-danger">Merk harus di pilih</p>');
			...
			if(categoryName == "") {
				$("#categoryName").after('<p class="text-danger">pilih kategori produk</p>');
			...
			if(productStatus == "") {
				$("#productStatus").after('<p class="text-danger">Pilih status produk dahulu</p>');
		...
		$.ajax({
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					if(productName == "") {
						$("#editProductName").after('<p class="text-danger">Nama produk harus di isi</p>');
					...
					if(quantity == "") {
						$("#editQuantity").after('<p class="text-danger">Masukan jumlah stok produk</p>');
					...
					if(rate == "") {
						$("#editRate").after('<p class="text-danger">Harga jual harus di isi</p>');
					...
					if(brandName == "") {
						$("#editBrandName").after('<p class="text-danger">Merk harus di pilih </p>');
					...
					if(categoryName == "") {
						$("#editCategoryName").after('<p class="text-danger">kategori harus di pilih </p>');
					...
					if(productStatus == "") {
						$("#editProductStatus").after('<p class="text-danger">Status produk harus dipilih</p>');
				...
				$("#updateProductImageForm").unbind('submit').bind('submit', function() {					
					...
					if(productImage == "") {
						$("#editProductImage").closest('.center-block').after('<p class="text-danger">Upload gambar foto produk</p>');
