$(document).ready(function() {
	...
	$("#changeUsernameForm").unbind('submit').bind('submit', function() {
		...
		if(username == "") {
			$("#username").after('<p class="text-danger">Username harus di isi</p>');
	...
	$("#changePasswordForm").unbind('submit').bind('submit', function() {
		...
		if(currentPassword == "" || newPassword == "" || conformPassword == "") {
			if(currentPassword == "") {
				$("#password").after('<p class="text-danger">Password harus di isi </p>');
			...
			if(newPassword == "") {
				$("#npassword").after('<p class="text-danger">Password baru harus di isi </p>');
			...
			if(conformPassword == "") {
				$("#cpassword").after('<p class="text-danger">Confrim Password harus di isi </p>');
